...
--
-- Host: 127.0.0.1    Database: catsandhumans
-- ------------------------------------------------------
...
CREATE TABLE `cats` (
  ...
  PRIMARY KEY (`idcats`),
  KEY `human_id_idx` (`human_id`),
  CONSTRAINT `human_id` FOREIGN KEY (`human_id`) REFERENCES `humans` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2024-07-18 11:22:45
